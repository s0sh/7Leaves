...
class ReferViewController: UIViewController , EPPickerDelegate , MFMessageComposeViewControllerDelegate{
    ...
    var tapReferralCode: UITapGestureRecognizer = UITapGestureRecognizer()
    ...
    override func viewDidLoad() {
        ...
        tapReferralCode = UITapGestureRecognizer(target: self, action: #selector(onTapReferralCode(sender:)))
        referralCode.addGestureRecognizer(tapReferralCode)
    }
    ...
    func onTapReferralCode(sender: UITapGestureRecognizer) {
        
        UIPasteboard.general.string = self.referralCode.text
        
        self.showAlert(withTitle: "Copy", message: "Referral code copied!")
        
        guard let msg = UIPasteboard.general.string else { return }
        
        print("Referral Code: \(msg)")
    }
    ...
    func epContactPicker(_: EPContactsPicker, didSelectMultipleContacts contacts: [EPContact]) {
        ...
        for contact in contacts {
            ...
            for phoneObj in contact.phoneNumbers {
                ...
                phoneNumbers.append(phoneObj.phoneNumber)
            }
        }
