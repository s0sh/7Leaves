...
//  LoyaltyCard(Simple)
//
//  Created by Khristoffer Julio on 16/2/2017.
//
//
...
class UserNotificationManager: NSObject {
    static func setBirthdayNotification(birthday: String) {
        ...
        debugPrint("Notification fire at => \(dateComponents.day!)-\(dateComponents.month!)-\(dateComponents.year!) \(dateComponents.hour!):\(dateComponents.minute!)")
